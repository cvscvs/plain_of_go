...
func GetArticleByTitle(title string) (*response.ArticleListParam, error) {
	var dataDto = *&response.ArticleListParam{}
	...
	for _, rr := range result {
		dataDto.Content = rr.Content
		dataDto.Title = rr.Title
		dataDto.Desc = rr.Desc
		break
	}
